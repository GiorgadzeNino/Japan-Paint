...
function drawColHints() {
    ...
    for (col = 0; col < userInputs.colHints.length; col++) {
...
function drawRowHints() {
    ...
    for (row = 0; row < userInputs.rowHints.length; row++) {
...
$(document).ready(function() {
    ...
    for (let column = 0; column > userInputs.colHints.length; column++) {
        // for(userInputs.colHints)
    }
